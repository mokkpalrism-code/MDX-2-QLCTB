...
print(" --- Đang gửi lệnh MDX vào Cube nè...")
try:
...
if not df.empty:
    ...
    print("\n--- TOP 10 NGUYÊN VẬT LIỆU CÓ BIÊN ĐỘ DAO ĐỘNG GIÁ CAO NHẤT (K VND) ---")
    ...
    # Gán chi nhánh tạm 
    df["ChiNhanh"] = "Chi nhánh Nguyễn Huệ"
    df["Nhom"] = df["ChiNhanh"] + " - " + df["NhaCungCap"]
    
    df = df.groupby(["ChiNhanh", "NhaCungCap", "NguyenLieu", "ThoiGian", "Nhom"], as_index=False).agg({
        "BienDo_K": "mean",
        "AvgPrice_K": "mean",
        "MaxPrice": "max",
        "MinPrice": "min"
    ...
    fig.update_layout(
        ...
        title={
            'text': "BIỂU ĐỒ 3D - BIẾN ĐỘNG GIÁ NGUYÊN VẬT LIỆU NĂM 2025",
        ...
        scene=dict(
            ...
            yaxis=dict(
                ...
                showticklabels=False,   # <--- ĐÃ TẮT TÊN NGUYÊN LIỆU
                tickangle=45,
